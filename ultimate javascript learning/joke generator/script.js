const jokes = [
  ...
  "Sandy’s mum has four kids; North, West, East. What is the name of the fourth child? Sandy.",
  ...
  "If an electric train is traveling south and the wind is blowing north, which way does the smoke blow? Electric trains don’t blow smoke.",
...
let user = prompt("Do you want to hear a joke? (yes/no)");
if(user === "yes"){
